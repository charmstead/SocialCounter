...
const url ='http://faceofzaron.zaron.com.ng/wp-admin/admin-ajax.php';
const data = { 'action':'vote_for_photo','photo_id':'1323','nonce_id':'ebfea02ca1'};
const options = {
    method: 'POST',
    headers: {
        ...
        Date: 'Thu, 09 Aug 2018 12:03:52 GMT'
    },
